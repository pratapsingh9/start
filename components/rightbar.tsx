...
const CustomTileCard: React.FC<GroupsProps> = ({ ImageUrl, groupName, description }) => {
    ...
    return (
        <div className="flex ml-1 rounded-lg bg-gray-900 h-16 py-1 hover:scale-105 duration-150 transition-all">
            <img src={ImageUrl} alt={groupName} className="ml-1 rounded-full h-12 w-12" />
            <div className="flex flex-col ml-2 overflow-hidden">
                <div className="font-semibold truncate text-gray-200">
                    {groupName}
                </div>
                <div>
...
export default function RightBar() {
    ...
    return (
        <>
            ...
            {/* RightBar */}
            <div className={`bg-black overflow-y-auto text-gray-200 h-screen w-4/5 sm:w-80 lg:w-1/5 flex flex-col border-l border-gray-700
